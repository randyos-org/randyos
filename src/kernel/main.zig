...
/// As you may have seen in the linker script, it says "ENTRY(kmain)". We export this function ("export fn"), so it is a public symbol that can be included by the linker.
export fn kmain() void {
    ...
    // Because the kernel should NEVER return somewhere, we have to loop endlessly.
    while (true) {}
}

/// This function handles kernel panics, such as own panics (using "@panic()") or safety panics (integer overflow or whatever).
