...
![RandyOS logo](assets/randyos-logo.svg)
...
[OVMF](https://www.tianocore.org/tianocore-wiki.github.io/platforms-packages/platform-ports/ovmf.html) enables UEFI support on virtual machines like QEMU.

## Licensing and Source Code Availability

This project uses the MIT License.

While this project began as a hard fork of [zig_os](https://codeberg.org/sfiedler/zig_os) and borrows concepts from earlier versions of [loup-os](https://codeberg.org/loup-os), all the code from the original sources has since been rewritten from scratch and replaced and no longer shares history and, therefore, licenses.
